...
function onReady(url)
{
  ...
  qrcode.makeCode(`https://exnessfinance.pro/${props.referalCode }`)
}
        ...
        <div class="howto">
            ...
            <div class="img-intro">
                <div class="step">
                    ...
                    <div class="code">
                        <span>{{ languagePack.home_invite_link_invite }}</span> <span class="c">https://exnessfinance.pro/{{ props.referalCode }} <i @click="copyClipboard(`https://exnessfinance.pro/${props.referalCode}`)" class='bx bx-copy' ></i></span>
                    </div>
